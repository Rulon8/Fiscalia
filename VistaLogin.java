...
public class VistaLogin extends CustomComponent {
	...
	public VistaLogin() {
		...
		embedded_1.setSource(new ThemeResource("img/logo_abogados.jpg"));
	...
	public void setVista() {
		...
		Row row0 = container.addRow();
		Col col0 = row0.addCol(ColMod.XS_10, ColMod.SM_8, ColMod.MD_4, ColOffsetMod.XS_OFFSET_1, ColOffsetMod.SM_OFFSET_2, ColOffsetMod.MD_OFFSET_4);
		col0.addComponent(embedded_1);
		
		Row row = container.addRow();
		Col col1 = row.addCol(ColMod.XS_12, ColOffsetMod.MD_OFFSET_2, MarginMod.TOP30);
	...
	private AbsoluteLayout buildMainLayout() {
		...
		labelTitulo.setValue("Ingreso al sistema de expedientes de la Fiscalía");
		...
		mainLayout.addComponent(embedded_1, "top:20.0px;left:370.0px;");
