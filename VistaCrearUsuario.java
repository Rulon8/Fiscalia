...
public class VistaCrearUsuario extends CustomComponent {
	...
	public void addVariosComboBoxInstructor(List<String> lista) {
	...
	public void addVariosComboBoxInstructor2(Container c) {
			comboBoxInstructor.setContainerDataSource( c );
	}
	...
	private AbsoluteLayout buildMainLayout() {
		...
		labelErrNom.setValue("Valor no valido");
		...
		labelErrApe.setValue("Valor no valido");
		...
		labelErrCor.setValue("Valor no valido");
		...
		labelErrTel.setValue("Valor no valido");
		...
		labelErrCed.setValue("Valor no valido");
		...
		labelErrCod.setValue("Valor no valido");
