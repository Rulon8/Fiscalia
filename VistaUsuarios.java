...
public class VistaUsuarios extends CustomComponent {
	...
	public VistaUsuarios() {
		...
		botonInstructorElim.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				instructor += itemInstructor.getItemProperty("Apellido").getValue().toString() + ", ";
	...
	public void setVista() {
		...
		Col col2 = row2.addCol(ColMod.XS_12, ColMod.MD_5, ColOffsetMod.MD_OFFSET_1);
		col2.addComponent(tablaUsuarios);
		
		Row row3 = container.addRow();
		Col col3 = row3.addCol(ColMod.XS_12, ColMod.SM_4, ColMod.MD_2, ColOffsetMod.MD_OFFSET_1);
		col3.addComponent(botonEliminar);
		Col col4 = row3.addCol(ColMod.XS_12, ColMod.SM_4, ColMod.MD_2, ColOffsetMod.MD_OFFSET_1);
		col4.addComponent(botonEliminar);
