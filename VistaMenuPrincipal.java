...
public class VistaMenuPrincipal extends CustomComponent {
	...
	public void setVista() {
		...
		Col col2 = row2.addCol(ColMod.XS_12, ColMod.MD_4, ColOffsetMod.MD_OFFSET_4, MarginMod.TOP30);
		...
		Col col4 = row4.addCol(ColMod.XS_12, ColMod.MD_4, ColOffsetMod.MD_OFFSET_1, MarginMod.TOP5);
		col4.addComponent(botonExpedientesActivos);
		Col col5 = row4.addCol(ColMod.XS_12, ColMod.MD_4, ColOffsetMod.MD_OFFSET_2, MarginMod.TOP5);
		col5.addComponent(botonExpedientesArchivados);
		Col col6 = row4.addCol(ColMod.XS_12, ColMod.MD_4, ColOffsetMod.MD_OFFSET_1, MarginMod.TOP5);
		col6.addComponent(botonCrearUsuario);
		Col col7 = row4.addCol(ColMod.XS_12, ColMod.MD_4, ColOffsetMod.MD_OFFSET_2, MarginMod.TOP5);
		col7.addComponent(botonCrearExpediente);
		Col col8 = row4.addCol(ColMod.XS_12, ColMod.MD_4, ColOffsetMod.MD_OFFSET_1, MarginMod.TOP5);
		col8.addComponent(botonCambiarPass);
		/* eliminar usuario
		 * Col col9 = row4.addCol(ColMod.XS_12, ColMod.MD_4, ColOffsetMod.MD_OFFSET_4);
		 * col9.addComponent(botonCrearExpediente);
		 */
		
		Row row5 = container.addRow();
		row5.addCol(MarginMod.TOP30);
		Col col10 = row5.addCol(ColMod.XS_12, ColMod.MD_2, ColOffsetMod.MD_OFFSET_5, MarginMod.TOP15);
