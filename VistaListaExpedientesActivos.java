...
public class VistaListaExpedientesActivos extends CustomComponent {
	...
	private void excel() {
		...
		excelExport = new ExcelExport(tableExpAct);
		excelExport.excludeCollapsedColumns();
		excelExport.setReportTitle("Expedientes Activos");
		excelExport.setExportFileName("ExpedientesActivos.xls");
	...
	private void csv() {
		tableExpAct.setImmediate(true);
		CsvExport csvExport;
		csvExport = new CsvExport(tableExpAct);
		csvExport.excludeCollapsedColumns();
		csvExport.setReportTitle("Expedientes Activos");
		csvExport.setExportFileName("ExpedientesActivos.csv");
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(buttonCsv, "top:506.0px;left:550.0px;");
