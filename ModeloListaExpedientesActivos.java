...
public class ModeloListaExpedientesActivos {
	...
	public void generarReporte() {
		String path = VaadinService.getCurrent().getBaseDirectory().getAbsolutePath() + "\\WEB-INF\\reporte\\ExpedientesActivos.pdf";
		try {
			Modelo m = Modelo.obtenerInstancia();
			Connection c = m.getConnectionPool().reserveConnection();
			Statement s = c.createStatement();
			String consulta = "SELECT codigo, numexpediente, instructorasig, fechaingreso, clasificacion FROM expediente WHERE archivado = false";
			...
			try {
				...
				parametros.put("Titulo", "Reporte de expedientes activos");
